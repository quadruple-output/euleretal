...
pub struct PositionContribution {
    inner: contributions::position::Variant,
}

impl From<contributions::position::Variant> for PositionContribution {
    fn from(data: contributions::position::Variant) -> Self {
        Self { inner: data }
    }
}
...
impl From<PositionRef> for PositionContribution {
    fn from(s_ref: PositionRef) -> Self {
        contributions::position::Variant::StartPosition { s_ref }.into()
    }
}

impl From<PositionContribution> for contributions::position::Variant {
...
impl std::ops::Add<PositionContribution> for PositionContribution {
    ...
    fn add(self, rhs: PositionContribution) -> Self::Output {
        contributions::position::Collection(vec![self.inner, rhs.inner])
    }
}

impl std::ops::Add<PositionContribution> for contributions::position::Collection {
    type Output = Self;
