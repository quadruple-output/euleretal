...
pub struct VelocityContribution {
    inner: contributions::velocity::Variant,
}

impl From<contributions::velocity::Variant> for VelocityContribution {
    fn from(data: contributions::velocity::Variant) -> Self {
        Self { inner: data }
    }
}
...
impl From<VelocityRef> for VelocityContribution {
    fn from(v_ref: VelocityRef) -> Self {
        contributions::velocity::Variant::Velocity { v_ref }.into()
    }
}

impl From<VelocityContribution> for contributions::velocity::Variant {
